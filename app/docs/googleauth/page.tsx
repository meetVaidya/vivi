...
const sections: ApiSection[] = [
    {
        ...
        description:
            "Initiates the Google OAuth flow, which redirects the user to Google’s consent page to authenticate via their Google account.",
        endpoint: "/api/v1/users/auth/google",
        method: "GET",
        request: `GET /api/v1/users/auth/google?redirect_url=http://frontend1.com/dashboard`,
        responseSuccess: `Redirects the user to Google's OAuth consent page.`,
        responseError: "",
    },
];
